...
radar_table = transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Fianna Fáil')][['year', 'cum_pct_trans_18']]
radar_table = radar_table.rename(columns = {'cum_pct_trans_18': 'Fianna Fáil'})

radar_table = pd.merge(radar_table, transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Labour Party')][['year', 'cum_pct_trans_18']], on='year', how='left')
radar_table = radar_table.rename(columns = {'cum_pct_trans_18': 'Labour Party'})

radar_table = pd.merge(radar_table, transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Fine Gael')][['year', 'cum_pct_trans_18']], on='year', how='left')
radar_table = radar_table.rename(columns = {'cum_pct_trans_18': 'Fine Gael'})

radar_table = pd.merge(radar_table, transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Independent')][['year', 'cum_pct_trans_18']], on='year', how='left')
radar_table = radar_table.rename(columns = {'cum_pct_trans_18': 'Independent'})

radar_table = pd.merge(radar_table, transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Green Party')][['year', 'cum_pct_trans_18']], on='year', how='left')
radar_table = radar_table.rename(columns = {'cum_pct_trans_18': 'Green Party'})

radar_table = pd.merge(radar_table, transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Sinn Féin')][['year', 'cum_pct_trans_18']], on='year', how='left')
radar_table = radar_table.rename(columns = {'cum_pct_trans_18': 'Sinn Féin'})

radar_table = pd.merge(radar_table, transfers[(transfers['party']=='Fine Gael') & (transfers['transfer_party']=='Progressive Democrats')][['year', 'cum_pct_trans_18']], on='year', how='left')
